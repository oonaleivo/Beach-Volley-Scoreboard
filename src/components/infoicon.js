    ...
    const InfoModal = () => (
        <div style={infoModalStyle}>
            ...
            <p style={{ color: 'black', lineHeight: '1.5' }}>
                ...
                <strong>About each mode:</strong><br />
                In beach mode sets go to 21 points with 2 point difference, and possible third set to 15.
                The scoreboard will also alert to switch sides every 7 points and in the third set every 5 points.
                In indoor mode sets go to 25 points with 2 point difference, and possible fifth set to 15. <br /><br />
